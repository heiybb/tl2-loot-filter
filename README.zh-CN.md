...
[![最新版本](https://img.shields.io/github/v/release/heiybb/tl2-loot-filter)](https://github.com/heiybb/tl2-loot-filter/releases/latest)

**[⬇ 下载最新构建 — tl2-loot-filter.zip](https://github.com/heiybb/tl2-loot-filter/releases/latest/download/tl2-loot-filter.zip)**

zip 内含 `zh/d3d9.dll` 和 `en/d3d9.dll`。挑你要的语言,把那个 `d3d9.dll` 放进游戏根目录(`Torchlight2.exe` 同级)——见 *安装 / 使用*。无需自己编译。(此链接永远指向最新 release。)
